	...
	<div class="flex flex-1 md:gap-1 lg:gap-2">
		<div class="flex items-center gap-2 lg:hidden">
			<a href="/" aria-current="page" aria-label="Homepage" class="flex-0 btn btn-ghost px-2 "
				><div
					class="font-title text-primary inline-flex text-lg transition-all duration-200"
				>
					<span class="lowercase text-primary">ESN</span>
					<span class="text-base-content">deFou</span>
				</div></a
			>
		</div>
	</div>
